...
fname_surf = '/Users/neichert/code/Brainhack/local_only_nicole/data/103414/MNINonLinear/fsaverage_LR32k/103414.L.inflated.32k_fs_LR.surf.gii'
...
fname_label = '/Users/neichert/code/Brainhack/Brainhack_Oxbridge/labels/103414/segments_L.func.gii'
my_labels = nib.load(fname_label)
my_inds = np.where(my_labels.darrays[1].data == 1)
#my_inds = np.arange(0, 32492)
...
nib.save(gii, '/Users/neichert/code/Brainhack/Brainhack_Oxbridge.surf.gii')
